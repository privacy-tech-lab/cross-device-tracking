...
<head>
    ...
    <title>Android Fingerprint</title>
...
<body>
    <fieldset>
    <legend><b>Android Fingerprint</b></legend>
    <p></p><br><br>
    Your device has the following fingerprint. Please click the submit button below to send us this information.
    ...
    <form name = "system_data_form" form action="android5.php" method="POST">
    ...
    <p>Android Sign Up Progress: 4/5</p>
    ...
    <script>
		...
		<!-- detect geolocation enabled (we ask users to allow geolocation access for our fingerprint) -->
